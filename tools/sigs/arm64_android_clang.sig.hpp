...
// Platform: arm64_android_clang (AArch64 Android (Clang))
...
#ifndef BOOST_TYPELAYOUT_SIG_ARM64_ANDROID_CLANG_HPP
#define BOOST_TYPELAYOUT_SIG_ARM64_ANDROID_CLANG_HPP

#include <boost/typelayout/tools/sig_types.hpp>

namespace boost { namespace typelayout { namespace platform {
namespace arm64_android_clang {

// ---- Platform Metadata ----

inline constexpr const char platform_name[] = "arm64_android_clang";
...
}}}} // namespace boost::typelayout::platform::arm64_android_clang

#endif // BOOST_TYPELAYOUT_SIG_ARM64_ANDROID_CLANG_HPP
