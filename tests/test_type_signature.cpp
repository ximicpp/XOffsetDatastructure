...
bool test_simple_signature() {
    ...
    // Note: On MSVC, manual type signature validation requires MSVCFieldRegistry specialization
    // which is only generated by the code generator. Skip compile-time check on MSVC.
